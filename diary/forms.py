...
class EntryForm(forms.ModelForm):
    """Форма для создания и редактирования записей дневника. Наследует от ModelForm и использует модель Entry.
    Включает поле выбора тегов с виджетом CheckboxSelectMultiple. Мета:
